...
function Skills() {
    ...
    const skills = [
        { icon: FaHtml5, color: 'text-blue-500', name: 'HTML5' },
    ...
    return (
        ...
        <div className='pb-24'>
            <h1 className='my-20 text-center text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent'>
                My Skills
            </h1>
            <div className='flex flex-wrap items-center justify-center gap-6'>
                {skills.map((skill, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className='group rounded-2xl bg-white p-6 shadow-md hover:shadow-lg transition-all hover:scale-105 relative flex flex-col items-center'
                        >
